...
void main(void) {
	...
	vec2 totalDistorion = (texture(dudvMap, distortedTexCoords).rg * 2.0 - 1.0) * waveStrength * clamp(waterDepth / 20.0, 0.0, 1.0);
	...
	vec3 specularHightlights = lightColour * specular * reflectivity * clamp(waterDepth / 5.0, 0.0, 1.0);
